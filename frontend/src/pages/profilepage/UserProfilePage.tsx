...
const UserProfilePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      <div className="bg-white border border-gray-200 shadow-md rounded-xl p-8 flex flex-col sm:flex-row gap-8 items-start">
        <img
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="pt-4">
            <Link to="/account/me/edit" className="px-4 py-2 text-sm font-medium bg-blue-700 text-white rounded-md hover:bg-blue-800 transition">
              Edit Profile
            </Link>
          </div>
        </div>
